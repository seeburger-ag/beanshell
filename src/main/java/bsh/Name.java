	...
	*/
		...
		throws UtilEvalError
	{
		...
		*/
		...
		if ("bsh".equals(evalName))
		{
			// Called by initialization in bsh.Interpreter.Interpreter(Reader, PrintStream, PrintStream, boolean, NameSpace, Interpreter, String)
			// if "bsh" is not found in "resolveThisFieldReference" above, makes no sense to travel through all imports and ClassLoaders below
